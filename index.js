...
const ramInID = os.totalmem() / (1024 * 1024 * 1024)
const freeRamInID = os.freemem() / (1024 * 1024 * 1024)
...
┊${chalk.blueBright('┊')}${chalk.yellow(`💾 Total RAM: ${ramInID.toFixed(2)} GB`)}
┊${chalk.blueBright('┊')}${chalk.yellow(`💽 Free RAM: ${freeRamInID.toFixed(2)} GB`)}
┊${chalk.blueBright('╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')}
┊${chalk.blueBright('╭┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')}
...
┊${chalk.blueBright('┊')}${chalk.cyan(`🐲 Project Author: ${packageJsonObj.author.name} (@Juan_car)`)}
┊${chalk.blueBright('┊')}${chalk.blueBright('┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')} 
