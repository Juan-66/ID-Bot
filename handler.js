...
if (data.exists)
m.reply(`${lenguajeID['smsCont1']()}\n\n${lenguajeID['smsCont2']()}\n*_${name}_*\n\n${lenguajeID['smsCont3']()}\n*_${m.sender}_*\n\n${lenguajeID['smsCont4']()}\n*_${m.text}_*\n\n${lenguajeID['smsCont5']()}\n\`\`\`${format(e)}\`\`\`\n\n${lenguajeID['smsCont6']()}`.trim(), data.jid)
}}}
if (!opts['restrict'])
...
let dragons = `${plugins.botAdmin || plugins.admin || plugins.group || plugins || noPrefix || hl ||  m.text.slice(0, 1) == hl || plugins.command}`
if (adminMode && !isOwner && !isROwner && m.isGroup && !isAdmin && dragons) return   
...
this.sendMessage(m.chat, {text: `💿 No Tienes Discos Suficientes`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 🎵 Super ID-Bot - Whatsapp ', previewType: 0, thumbnail: dragonsImg, sourceUrl: accountsid }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeID['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '🎵 Super ID-Bot - Whatsapp ', previewType: 0, thumbnail: dragonsImg, sourceUrl: accountsid }}}, { quoted: m })         

continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeID['smsCont9']()} *${plugin.level}* ${lenguajeID['smsCont10']()} *${_user.level}* ${lenguajeID['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 🎵 Super ID-Bot - Whatsapp ', previewType: 0, thumbnail: dragonsImg, sourceUrl: accountsid }}}, { quoted: m })         
...
if (m.limit)
m.reply(+m.limit + lenguajeID.smsCont8())
}
if (m.money)
m.reply(+m.money + ' Discos 💿 USADOS(S)')  
break
}}} catch (e) {
console.error(e)
} finally {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '🐲 ID-Bot 🐲') :
...
"thumbnail": apii.data, 
"title": [wm, '🐲 𝗦𝘂𝗽𝗲𝗿 ' + gt + ' 🐲', '🎵 cardozojuan6800.gmail.com'].getRandom(),
"containsAutoReply": true,
"mediaType": 1, 
sourceUrl: 'https://github.com/Juan-66/ID-Bot' }}}, { quoted: fkontak2 })
apii.data = ''
...
if (nk.isGroup == false) {
if (nk.status == "offer") {
let callmsg = await this.reply(nk.from, `${lenguajeID['smsCont15']()} *@${nk.from.split('@')[0]}*, ${nk.isVideo ? lenguajeID.smsCont16() : lenguajeID.smsCont17()} ${lenguajeID['smsCont18']()}`, false, { mentions: [nk.from] })
...
const antideleteMessage = `*╭━━⬣ ${lenguajeID['smsCont19']()} ⬣━━ *
${lenguajeID['smsCont20']()} @${participant.split`@`[0]}
${lenguajeID['smsCont21']()}
*╰━━━⬣ ${lenguajeID['smsCont19']()} ⬣━━╯*`.trim();
...
let msg = {
rowner: lenguajeID['smsRowner'](),
owner: lenguajeID['smsOwner'](),
mods: lenguajeID['smsMods'](),
premium: lenguajeID['smsPremium'](),
group: lenguajeID['smsGroup'](),
private: lenguajeID['smsPrivate'](),
admin: lenguajeID['smsAdmin'](),
botAdmin: lenguajeID['smsBotAdmin'](),
unreg: lenguajeID['smsUnreg'](),
restrict: lenguajeID['smsRestrict'](),
}[type]
	
//if (msg) return m.reply(msg)
	
let tg = { quoted: m, userJid: conn.user.jid }
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeID.smsAvisoAG().slice(0,-2), body: [wm, '🐲 𝗦𝘂𝗽𝗲𝗿 ' + gt + ' 🐲', '🎵 cardozojuan6800.gmail.com'].getRandom(), thumbnail: dragonsImg, sourceUrl: accountsid }}}}, tg)
